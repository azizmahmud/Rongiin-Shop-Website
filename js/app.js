...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img src="${images}" class="product-image mx-auto mt-5" alt="...">
    <div class="card-body">
      <div class="d-flex justify-content-center gap-4 mt-4 ms-2">
    ...
    <div class=" d-flex justify-content-center mb-5">
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-warning mx-3">add to cart</button>
